...
public:
	...
	void Update(entt::basic_view<entt::entity, entt::exclude_t<>, TransformComponent, TagComponent> entities, double dt) override
	{
		for (auto entity : entities) {
			auto [transform, tag] = entities.get<TransformComponent, TagComponent>(entity);
			if (tag.Tag == "Cube") {
