	...
	std::shared_ptr<lava::pipeline::AdvancedRenderingPipeline> pipeline)
{
	...
	ci.addStage(
		lava::pack::shader(device, "shaders/opaque_vert.spv"));
	ci.addStage(
		lava::pack::shader(device, "shaders/opaque_frag.spv"));
	...
	std::shared_ptr<lava::pipeline::AdvancedRenderingPipeline> pipeline)
{
	...
	ci.addStage(
		lava::pack::shader(device, "shaders/transparent_frag.spv"));
	...
	std::shared_ptr<lava::pipeline::AdvancedRenderingPipeline> pipeline)
{
	...
	ci.addStage(
		lava::pack::shader(device, "shaders/transparentTexturedSimple_vert.spv"));
	ci.addStage(
		lava::pack::shader(device, "shaders/transparentTexturedSimple_frag.spv"));
	...
	std::shared_ptr<lava::pipeline::AdvancedRenderingPipeline> pipeline)
{
	...
	ci.addStage(
		lava::pack::shader(device, "shaders/shadowMap_frag.spv"));
